        ...
        <div ref='main'>
          <Grid>
            <Row>
              ...
              <Description title='Not Stupid' body='I recently built a TLS/SSL VPN from scratch on VMs... because graduate school is wild. I went from, "What is git?" to productionizing a web application with user auth & a dynamic database in 10 weeks.
              I became the first junior member of a production engineering team, dove into a massive enterprise codebase and an on-call rotation with no prior exposure to the languages, libraries, or tooling, & shipped an incident-preventing feature my second month.'/>

              <Description title='"#Rockstar"' body="I am pursuing a MS in Cybersecurity at NYU while working full time. I am fascinated by IoT Security, & aspire to lead a Red Team some day. I code daily in Ruby, Go, & SQL at Salesforce (Heroku), and in C++ & Python at NYU. I created this portfolio with ReactJS, and analyzed data with STATA & R at UCSD. Away from the internet, I train martial arts, volunteer in marine conservation (Rescue Diver), and ran a talent agency with a dude nicknamed 'Sexy Stalin'. " />
            </Row>
          </Grid>
          <Row>
          </Row>
