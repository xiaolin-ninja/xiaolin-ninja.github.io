  ...
  render() {
    ...
    return (
      <div style={a}>
        ...
        <p/>
        I bring to the table a unique combination of experiences in production engineering, security, entrepreneurship, and international policy, as well as a passion for action. I can't wait to help keep Rockstar players, employees, and intellectual property safe.
      </div>
    )
  }
}
