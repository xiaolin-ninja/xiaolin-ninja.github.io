...
class Description extends Component {
  render() {
    ...
    return (
      <div style={a}>
        Bold, honest, and unapologetically authentic. Those are words I would use to describe myself, and adjectives that have made me a loyal consumer of VICE for years. I am a highly mission-driven person, and if I am going to spend 60% of my waking hours contributing to a corporation, I want to spend it protecting the data and integrity of an impactful modern media company with ethical, hard-hitting content that inspires and invigorates generations.
        <p/>
